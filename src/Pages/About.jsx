...
function About(){
    ...
    return <Box id="About" bg={colorMode==="light"? "linear-gradient(180deg, rgba(44,23,75,1) 45%, rgba(28,14,50,1) 99%)" : "#bdb6c9"} color="#ffffff" p="30px 0px" mt="-2px" pt={["50px", "70px", "80px"]}>
        <Box w="87%" m="auto">
