...
function Contacts(){
    ...
    return <Box id="Contact" bg={darkTheme==="dark"? "linear-gradient(180deg, rgba(44,23,75,1) 45%, rgba(28,14,50,1) 99%)" : "#bdb6c9"} color={darkTheme==="dark"? "white" : "#13022C"} p="60px 0px" pt="75px">
            ...
            <Box>
                <Box p={["15px", "38px", "15px"]}>
                    ...
                    <Box display={["inline", "flex", "flex"]} gap={["", "7px", "15px"]} alignItems="center">
                        <Icon as={AiOutlineLinkedin} w={["40px", "30px", "40px"]} h="50px" color={darkTheme==="dark"? "white" : "#13022C"} />
                    ...
                    <Box display={["inline", "flex", "flex"]} gap={["", "10px", "15px"]} alignItems="center">
                        <Icon as={AiOutlineLink} w={["40px", "30px", "40px"]} h="50px" color={darkTheme==="dark"? "white" : "#13022C"} />
