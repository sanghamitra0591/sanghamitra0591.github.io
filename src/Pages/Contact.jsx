...
function Contacts() {
        ...
        emailjs.send('service_3i8hq0k', 'template_mwm1m6l', values, 'i5rrp59HT6jNdKwT8')
            .then(response => {
                ...
                toast({
                    ...
                    render: () => (
                        <Box bg={colorMode === "light" ? "#C1B6DB" : "#251942"} color={colorMode === "light" ? "#13022c" : "white"} p={4} m={4} borderRadius="md" boxShadow="md">
                            <Text color={colorMode === "light" ? "#13022c" : "white"}>Message Sent.</Text>
                        </Box>
                    ),
                })
            }, error => {
                ...
                toast({
                    ...
                    render: () => (
                        <Box bg={colorMode === "light" ? "#C1B6DB" : "#251942"} color={colorMode === "light" ? "#13022c" : "white"} p={4} m={4} borderRadius="md" boxShadow="md">
                            <Text color={colorMode === "light" ? "#13022c" : "white"}>Something wrong.</Text>
                        </Box>
                    ),
                })
            });
    ...
    return <Box id="Contactt" bg={colorMode === "light" ? "linear-gradient(180deg, rgba(44,23,75,1) 45%, rgba(28,14,50,1) 99%)" : "#bdb6c9"} color={colorMode === "light" ? "white" : "#13022C"} p={["30px 0px", "30px 0px", "60px 0px"]} pt="75px">
        ...
        <Box w={["80%", "85%", "85%"]} m="auto" mt="50px" textAlign="center" p="60px auto" display={["inline", "inline", "flex"]} justifyContent="space-between" alignItems="center">
            <Box w={["80%", "80%", "40%"]} m="auto" display={["none", "none", "inline"]}>
                <Box w="100%" p={["15px", "38px", "15px"]} display="grid" gap="20px" gridTemplateColumns={["Repeat(4, 1fr)", "Repeat(4, 1fr)", "Repeat(2, 1fr)"]}>
                    <Box mb="20px">
                        <a id="contact-phone" href="tel:7894272853" rel="noreferrer" target="_blank">
                    ...
                    <Box mb="20px">
                        <a id="contact-email" href="mailto: sanghamitramymail@gmail.com" rel="noreferrer" target="_blank">
                            <Button _hover={{ bg: "#4E406F", color: "#ffffff" }} p={["0px", "20px", "35px"]} fontSize={["2xl", "4xl", "6xl"]}
                                bg={colorMode === "light" ? "#C1B6DB" : "#251942"} color={colorMode === "light" ? "#13022c" : "white"}
                    ...
                    <Box mb="20px">
                        <a id="contact-github" href="https://github.com/sanghamitra0591" rel="noreferrer" target="_blank">
                            <Button _hover={{ bg: "#4E406F", color: "#ffffff" }} p={["0px", "20px", "35px"]} fontSize={["2xl", "4xl", "6xl"]}
                                bg={colorMode === "light" ? "#C1B6DB" : "#251942"} color={colorMode === "light" ? "#13022c" : "white"}
                    ...
                    <Box mb="20px">
                        <a id="contact-linkedin" href="https://www.linkedin.com/in/sanghamitra-satpathy/" rel="noreferrer" target="_blank">
                            <Button _hover={{ bg: "#4E406F", color: "#ffffff" }} p={["0px", "20px", "35px"]} fontSize={["2xl", "4xl", "6xl"]}
                                bg={colorMode === "light" ? "#C1B6DB" : "#251942"} color={colorMode === "light" ? "#13022c" : "white"}
