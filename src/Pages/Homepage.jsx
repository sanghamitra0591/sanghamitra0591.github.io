...
function Homepage(){
    ...
    return <Box bg={colorMode==="dark"? "#13022C" : "#d3cedb"}>
        <Box id="Home" w="100.1156%" ml="-1.069px" pt={["50px", "50px", "50px"]} color="#e1cefd" bg={colorMode==="dark"? "#13022C" : "#d3cedb"}>
                <Box h="570px" w="85%" color={colorMode==="dark"? "#d3cedb" : "#13022C"} m="auto" display={["inline", "inline", "flex"]} alignItems="center" justifyContent="space-around" pb="60px">
                    <Box mt={["50px", "50px", "0px"]} w={["100%", "100%", "60%"]}>
                        <Box textAlign="left" pl={["20px", "60px", "20px"]}>
                            ...
                            fontSize={["md", "lg", "xl"]} bg={colorMode==="dark"? "#C1B6DB" : "#251942"} 
                            color={colorMode==="dark"? "#13022c" : "white"} border="none" variant='solid' leftIcon={<DownloadIcon />}>
                            ...
                            <Box mt="15px" gap="15px" display="flex" color="#13022c">
                                <a href="https://github.com/sanghamitra0591" rel="noreferrer" target="_blank"><Button _hover={{bg:"#4E406F", color:"#ffffff"}} pr="0px"pl="5px" fontSize={["2xl", "3xl", "4xl"]} bg={colorMode==="dark"? "#C1B6DB" : "#251942"} color={colorMode==="dark"? "#13022c" : "white"} border="none" variant='solid' leftIcon={<AiOutlineGithub />}></Button></a>
                                <a href="https://www.linkedin.com/in/sanghamitra-satpathy/" rel="noreferrer" target="_blank"><Button _hover={{bg:"#4E406F", color:"#ffffff"}} pr="0px" pl="5px" fontSize={["2xl", "3xl", "4xl"]} bg={colorMode==="dark"? "#C1B6DB" : "#251942"} color={colorMode==="dark"? "#13022c" : "white"} border="none" variant='solid' leftIcon={<AiOutlineLinkedin />}></Button></a>
                            </Box>
                        </Box>
                </Box>
                <Box bg={colorMode==="dark"? "#C4A9EC" : "#301952"} p="5px" w={["45%", "35%", "25%"]} m="20px auto 0px auto" rounded={["50%", "50%", "50%"]}>
