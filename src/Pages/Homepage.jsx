...
function Homepage(){
    return <Box bg="#13022C" position="relative">
        <Box id="Home" w="100.1156%" ml="-1.069px" pt={["100px", "50px", "50px"]} color="#e1cefd" bg="#13022C">
                <Box h="574px" w="85%" color="#d3cedb" m="auto" display={["inline", "inline", "flex"]} alignItems="center" justifyContent="space-around">
                    <Box mt={["50px", "50px", "0px"]} w={["100%", "100%", "60%"]}>
                        <Box textAlign="left" pl={["20px", "60px", "20px"]}>
                            ...
                            <Button _hover={{bg:"#C1B6DB", color:"#13022c"}} mt="10px" p={["15px 15px", "20px 20px", "25px 25px"]} fontSize={["md", "lg", "xl"]} bg="#C1B6DB" color="#13022c" border="none" variant='solid' leftIcon={<DownloadIcon />}>
                            ...
                            <Box mt="15px" gap="15px" display="flex" color="#13022c">
                                <a href="https://github.com/sanghamitra0591" rel="noreferrer" target="_blank"><Button _hover={{bg:"#4E406F", color:"#ffffff"}} pr="0px"pl="5px" fontSize={["2xl", "3xl", "4xl"]} bg="#C1B6DB" color="#13022c" border="none" variant='solid' leftIcon={<AiOutlineGithub />}></Button></a>
